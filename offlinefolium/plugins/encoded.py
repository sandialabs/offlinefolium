...
from offlinefolium.features import MacroElement
from offlinefolium.template import Template
from offlinefolium.vector_layers import path_options
...
class PolyLineFromEncoded(_BaseFromEncoded):
    ...
    **kwargs:
    ...
    Examples
    --------
    >>> from offlinefolium import Map
    >>> from offlinefolium.plugins import PolyLineFromEncoded
    >>> m = Map()
...
class PolygonFromEncoded(_BaseFromEncoded):
    ...
    **kwargs:
    ...
    --------
    >>> from offlinefolium import Map
    >>> from offlinefolium.plugins import PolygonFromEncoded
    >>> m = Map()
