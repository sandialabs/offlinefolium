...
from offlinefolium.features import GeoJson
from offlinefolium.offlinefolium import Map
from offlinefolium.template import Template
from offlinefolium.utilities import JsCode, get_bounds, remove_empty
...
class Timeline(GeoJson):
    ...
    * 'startExclusive' and 'endExclusive' should be boolean values.
    ...
    Examples
    --------
    >>> from offlinefolium.plugins import Timeline, TimelineSlider
    >>> m = folium.Map()
