...
from offlinefolium.elements import ElementAddToElement, EventHandler, IncludeStatement
from offlinefolium.template import Template
from offlinefolium.utilities import (
    JsCode,
    TypeBounds,
    TypeBoundsReturn,
    TypeJsonValue,
...
if TYPE_CHECKING:
    from offlinefolium.features import CustomIcon, DivIcon
...
class Marker(MacroElement):
    ...
    def add_child(self, child, name=None, index=None):
        import offlinefolium.features as features
